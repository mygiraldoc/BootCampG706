...
# MultinomialNB modelo de intelgencia artificial que aprende relacion entre texto y respuestas
#==============================================================================================
# Función build_and_train_model
#==============================================================================================
def build_and_train_model (train_pairs):
  # train_pairs: Listas de pares(preguntas,respuestas)
  # Ejemplos [("Hola","¡Hola!"),("adiós","¡Hasta Luego!")]

  # separamos las preguntas y respuestas en dos listas
  questions =[q for q, _ in train_pairs] # Listas de preguntas
  ...
  # convertimos las respuestas en números
  y = [answer_to_label[a] for a in answers]
  # creamos una lista con las etiquetas númericas de las respuestas
  ...
  model.fit(x,y)
  # Devolvemos el modelo y el vectorizador
...
def predict_answers(model, vectorizer, unique_answers,user_text):
  ...
  # el modelo predecir la etiqueta(número) de la respuesta correcta
